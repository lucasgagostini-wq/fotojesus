      ...
      <div className="grid grid-cols-2 gap-4">
        {STYLES.map((style) => (
          <div key={style.id} className="card-style relative aspect-[3/4] overflow-hidden">
            ...
            <div className="absolute bottom-0 inset-x-0 py-2.5 px-2 text-[10px] font-semibold text-white text-center">
              {style.label}
            </div>
          </div>
        ))}
...
function UploadScreen({ onFileSelect }: { onFileSelect: (url: string) => void }) {
  ...
  return (
    <div className="content-wrapper animate-in fade-in duration-300">
      ...
      <div className="border-2 border-red-500 bg-red-50 rounded-xl p-4 flex items-center gap-3 text-red-600">
      ...
      <div className="bg-yellow-50 rounded-2xl p-4 border border-yellow-300 text-center">
...
function ResultsScreen({ selectedIds, setSelectedIds, onContinue }: {
  ...
  return (
    <div className="content-wrapper animate-in fade-in duration-300">
      ...
      <div className="rounded-2xl overflow-hidden border-2 border-brand-gold shadow-sm">
              ...
              >
                ...
                {!isSelected && (
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="bg-brand-gold text-white text-[10px] font-black px-3 py-1 rounded-full shadow-md">
                      TOQUE 👆
                    </div>
                  </div>
                )}
      ...
      <div className="flex flex-col gap-1.5 mt-4">
        <p className="text-xs text-gray-400 font-medium flex items-center gap-2">⏳ Sua imagem fica disponível por tempo limitado</p>
        <p className="text-xs text-gray-700 font-medium flex items-center gap-2">✝️ Imagem pronta para você guardar para sempre</p>
      </div>
