...
-- Funnel Analytics: tabela DESACOPLADA (order_id nullable, SEM FK) — eventos de
-- funil podem ocorrer antes de existir um pedido (landing/styles/results) e
-- nenhuma lógica de negócio depende disto. Insert nunca falha por FK.
